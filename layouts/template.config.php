...
if (($wrapper_border = $this['config']->get('wrapper_border')) && $this['path']->path("css:/wrapper/$wrapper_border.css")) { $this['asset']->addFile('css', "css:/wrapper/$wrapper_border.css"); }
...
$fonts = array(
	...
	'opensansupper' => 'template:fonts/opensans.css',
	'pt' => 'template:fonts/pt.css',
	'winterthur' => 'template:fonts/winterthur.css',
	'metrophobic' => 'template:fonts/metrophobic.css',
	'droidserifitalic' => 'template:fonts/droidserifitalic.css',
	'istok' => 'template:fonts/istok.css',
	'muli' => 'template:fonts/muli.css',
	'vollkorn' => 'template:fonts/vollkorn.css',
	'yanonekaffeesatz' => 'template:fonts/yanonekaffeesatz.css',
	'yanonekaffeesatzupper' => 'template:fonts/yanonekaffeesatz.css'
);
