...
<head>
	...
	<style>
       body {
       	background: url("/wp-content/themes/yoo_tasty_wp/images/background/kapuzinerhof-background.jpg") no-repeat fixed center center / cover rgba(0, 0, 0, 0);
       }
	</style>
</head>
...
<body id="page" class="page">
	...
	<div class="center error-<?php echo strtolower($error); ?>">
		<img src="http://www.kapuzinerhof.de/wp-content/themes/yoo_tasty_wp/images/kapuzinerhof.png" />
