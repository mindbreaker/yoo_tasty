...
class UseragentWarpHelper extends WarpHelper {
	...
	*/
	...
	public function filterGoogleAndroid(&$userAgent) {
		if ('safari' === $userAgent['browser_name'] && strpos($userAgent['string'], 'android') !== false) {
			$userAgent['operating_system'] = strpos($userAgent['string'], 'mobile') !== false ? 'android' : 'android.tablet';
		}
	}
	...
	public function filterGoogleChrome(&$userAgent) {
		if ('safari' === $userAgent['browser_name'] && strpos($userAgent['string'], 'chrome/') !== false) {
	...
	public function filterSafariVersion(&$userAgent) {
		if ('safari' === $userAgent['browser_name'] && strpos($userAgent['string'], ' version/') !== false) {
	...
	public function filterOperaVersion(&$userAgent) {
		if ('opera' === $userAgent['browser_name'] && strpos($userAgent['string'], ' version/') !== false) {
	...
	public function filterYahoo(&$userAgent) {
		if (null === $userAgent['browser_name'] && strpos($userAgent['string'], 'yahoo! slurp') !== false) {
